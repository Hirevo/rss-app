<script lang="ts">
    ...
    function register() {
        loading = true;
        state.register(email, name, password).then(() => {
            loading = false;
            navigate("/");
        });
    }
...
<div class="root">
    ...
    <div class="content-container centered">
        <div class="content vstack">
            ...
            <div><Button on:click={register}>Register</Button></div>
            <div><Link to="/login"><Button>Already have an account ?</Button></Link></div>
